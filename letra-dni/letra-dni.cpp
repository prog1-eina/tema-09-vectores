...
/*
 * Pre:  dni > 0
 * Post: Ha devuelto la letra del DNI que corresponde a un número de DNI igual al
 *       valor del parámetro «dni».
 */
char letra(const int dni) {
    const int NUM_LETRAS = 23;
    const char TABLA_LETRAS_NIF[NUM_LETRAS] = {'T', 'R', 'W', 'A', 'G', 'M', 'Y',
